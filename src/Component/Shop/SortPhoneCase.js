...
export default function SortPhoneCase() {
    ...
    useEffect(() => {
        axios.get('http://localhost:3010/pkdd/products')
            .then(response => {
                ...
                setFilteredProducts(sortedProducts.filter(product => product.category === "Phone-case"));
            })
            .catch(error => {
                ...
                <div className="container">
                    <div className="row">
                        <h4 className="text-center mb-4">
                            <span className="px-2 position-relative fw-bolder fs-1">Screen Protectors</span>
                        </h4>
